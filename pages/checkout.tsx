                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className="row">
                                    <div className="col-lg-9">
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6">
                                                <label htmlFor="shipInfo.receiveAreaCode">{t('receiver_county')} *</label>
                                                <div className="select-custom">
                                                    <select
                                                        ref={register}
                                        ...
                                        <label htmlFor="shipInfo.receiveAddress">{t('receiver_detail_address')} *</label>
                                        <input
                                            ref={register({ required: true })}
                                            type="text"
                                        ...
                                        <div className="select-custom">
                                            ...
                                            >
                                                ...
                                                <option value={InvoiceFromType.MemberDriver}>{t('member_invoice_carrier')}</option>
                                                <option value={InvoiceFromType.PhoneBarcode}>{t('phone_barcode')} </option>
